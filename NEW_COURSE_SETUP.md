...
| `scripts/` (audit, voice-check, sync, this seed script) | `_project_docs/claude_course_plan.md` (cadence/sequence) | `_adm/`, `_announcements/` (per-term, private) |
