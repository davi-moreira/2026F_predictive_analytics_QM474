...
> Read [`CLAUDE.md`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/CLAUDE.md) and [`_project_docs/MGMT47400_FullSemester_Plan_2026Fall.md`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/_project_docs/MGMT47400_FullSemester_Plan_2026Fall.md). Describe back to me how this course is structured: the pedagogy, the 20-notebook arc, the source-of-truth files, and the rules that are non-obvious.
...
c. Spot-check by opening one notebook the assistant cites, for example [`notebooks/nb08_cross_validation_model_comparison_student.ipynb`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/notebooks/nb08_cross_validation_model_comparison_student.ipynb), so you can see what "canonical voice" actually looks like.

## Step 3. Translate the constitution to your domain

a. Copy [`CLAUDE.md`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/CLAUDE.md) into your own repo (`CLAUDE.md` or `claude.md`, either works), then ask the assistant to adapt it:
...
c. Also copy and adapt the companion files: [`DECISIONS.md`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/_project_docs/DECISIONS.md), [`TROUBLESHOOTING.md`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/_project_docs/TROUBLESHOOTING.md), and [`NOTEBOOK_TEMPLATE.md`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/_project_docs/NOTEBOOK_TEMPLATE.md). They start small and grow alongside the project.
...
- [`scripts/audit_cv_first.py`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/scripts/audit_cv_first.py)
- [`scripts/voice_check_guides.py`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/scripts/voice_check_guides.py)
...
- *Any course with student-facing materials:* a voice check like [`voice_check_guides.py`](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/blob/main/scripts/voice_check_guides.py).
...
b. Save that file inside `_quizzes/` in your repo. This becomes your **schema example**.

c. Generate the next quiz by pointing the assistant at the schema example:

> Use `_quizzes/<term>/<example-quiz>.csv` as the format. Generate a 10-question quiz on [topic], in the same CSV shape, with plausible distractors and one correct answer per question.
...
a. Open an issue on the [course repository](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/issues) describing what you adapted, what worked, and what failed.
