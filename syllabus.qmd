...
-   Office Hours: **Tuesdays 11:00 am -- 12:00 pm EST** (in person or Zoom; link on Brightspace)
...
In **groups of four randomly assigned members**, students complete a practical predictive analytics project culminating in a **research poster** presented at the Undergraduate Research Conference. The post-conference **Poster-to-Product** build sprint is graded separately (see below).

Each group builds an end-to-end predictive analytics project across the M00–M12 milestone track and presents the resulting poster at the **Fall 2026 Purdue Undergraduate Research Conference on Tuesday, November 17, 2026**. **Presentation at the conference is required for all students.** The final poster is due **one week before the conference (Tuesday, November 10, 2026)**. Professor Moreira serves as faculty mentor throughout.

**Grading breakdown (of the final-project grade):**

1.  **Milestone Deliverables (40%):** Incremental submissions across the M00–M12 milestone track (numbering follows the [Final Project milestone reference](https://github.com/davi-moreira/2026F_predictive_analytics_QM474/tree/main/_final_project/2026F) and skips M04/M07/M13). Due dates are listed on the [Schedule](./schedule.qmd).
2.  **Peer Evaluation (20%):** A confidential intra-group evaluation of each member's contribution, ensuring balanced participation and collaborative accountability.
3.  **Instructor / TA Evaluation (40%):** Evaluation of the final poster and the conference presentation.
...
After the conference, groups enter a **two-week in-class build sprint** that converts the validated model into a **stakeholder-ready dashboard/app plus an executive brief**, following an industry product workflow (scope → data engineering → model validation → UX → deployment → usability test → showcase). Each team works with an assigned AI assistant under human-in-the-loop sign-offs and receives feedback from industry/nonprofit partners, culminating in a **showcase on Wednesday, December 9, 2026**. *(This experiential capstone is supported by a Daniels School Experiential Learning Grant.)*

**Grading breakdown (of the Poster-to-Product grade):**

1.  **Deliverables and Showcase (80%):** The deployed dashboard/app, the executive brief, and the showcase presentation, assessed on the **NACE competencies** — Technology, Teamwork, Communication, and Critical Thinking — via rubric.
2.  **Peer Evaluation (20%):** A confidential intra-group evaluation of each member's contribution to the sprint.
